...
public class LinuxTest3 {
    ...
    void fastDiag() {
        ...
        assertEquals(3, firstDiagFD.size());
        assertEquals("[ARCH_INLINE_SPIN_UNLOCK_IRQ=true, INIT_ALL_POSSIBLE=true, ARCH_INLINE_READ_TRYLOCK=true]", firstDiagFD.toString());
    }
    ...
    void fastDiagPV4() {
        ...
        assertEquals(3, firstDiag.size());
        assertEquals("[ARCH_INLINE_SPIN_UNLOCK_IRQ=true, INIT_ALL_POSSIBLE=true, ARCH_INLINE_READ_TRYLOCK=true]", firstDiag.toString());
    }
